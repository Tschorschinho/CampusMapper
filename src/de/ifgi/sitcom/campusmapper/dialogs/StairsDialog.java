...
import de.ifgi.sitcom.campusmapper.activities.ChooseLocationActivity;
import de.ifgi.sitcom.campusmapper.activities.IndoorConnectionActivity;
import de.ifgi.sitcom.campusmapper.handler.UIActionHandler;
import de.ifgi.sitcom.campusmapper.indoordata.Connection;
import de.ifgi.sitcom.campusmapper.indoordata.FloorPlan;
import de.ifgi.sitcom.campusmapper.indoordata.Stairs;
import de.ifgi.sitcom.campusmapper.indoordata.VerticalConnection;
import de.ifgi.sitcom.campusmapper.indoordata.geometry.EmptyGeometry;
				...
				try {
					...
					intent.putExtra(ChooseLocationActivity.EXTRA_BUILDING_URI, mBuildingURI);
						...
						Toast.makeText(getSherlockActivity(),
								"Bitte wählen Sie ein anderes Stockwerk aus.",
					...
					Toast.makeText(getSherlockActivity(),
							"Bitte wählen Sie das Stockwerk aus.",
							Toast.LENGTH_SHORT).show();
				}
