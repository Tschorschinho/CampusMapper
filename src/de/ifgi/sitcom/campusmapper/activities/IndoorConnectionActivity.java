...
import de.ifgi.sitcom.campusmapper.dialogs.ChoosePlanDialog;
import de.ifgi.sitcom.campusmapper.dialogs.SettingsDialog;
import de.ifgi.sitcom.campusmapper.dialogs.ChoosePlanDialog.ChoosePlanDialogListener;
import de.ifgi.sitcom.campusmapper.handler.mapping.SelectTargetHandler;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_done:
			...
			if (mSelectFeatureHandler.getPosition() != null) {
				...
				Toast.makeText(this, "Bitte treffen Sie eine Auswahl.",
