...
import de.ifgi.sitcom.campusmapper.dialogs.AutoMapDialog;
import de.ifgi.sitcom.campusmapper.dialogs.SettingsDialog;
import de.ifgi.sitcom.campusmapper.dialogs.AutoMapDialog.AutoMappingDialogListener;
import de.ifgi.sitcom.campusmapper.exceptions.UploadException;
import de.ifgi.sitcom.campusmapper.handler.UIActionHandler;
import de.ifgi.sitcom.campusmapper.handler.mapping.AutoMapHandler;
import de.ifgi.sitcom.campusmapper.handler.mapping.CorridorHandler;
import de.ifgi.sitcom.campusmapper.handler.mapping.DoorHandler;
import de.ifgi.sitcom.campusmapper.handler.mapping.EditHandler;
import de.ifgi.sitcom.campusmapper.handler.mapping.EntranceHandler;
import de.ifgi.sitcom.campusmapper.handler.mapping.RoomHandler;
import de.ifgi.sitcom.campusmapper.handler.mapping.StairsHandler;
import de.ifgi.sitcom.campusmapper.indoordata.FloorPlan;
import de.ifgi.sitcom.campusmapper.indoordata.Person;
import de.ifgi.sitcom.campusmapper.io.ImageUpload;
import de.ifgi.sitcom.campusmapper.io.RDFWriter;
import de.ifgi.sitcom.campusmapper.io.RDFReader;
import de.ifgi.sitcom.campusmapper.io.RDFUpload;
import de.ifgi.sitcom.campusmapper.io.TripleStoreQueries;
import de.ifgi.sitcom.campusmapper.views.ImageView;
...
//	    actionBar.setDisplayShowTitleEnabled(false);
	    ...
	    // corridor
	    Tab tab = actionBar.newTab().setText("Flur").setTabListener(new TabListener(new CorridorHandler(mFloorPlan, this)));
	    actionBar.addTab(tab);

	    // room
	    tab = actionBar.newTab().setText("Raum").setTabListener(new TabListener(new RoomHandler(mFloorPlan, this)));
	    actionBar.addTab(tab);

	    // door
	    tab = actionBar.newTab().setText("Tür").setTabListener(new TabListener(new DoorHandler(mFloorPlan, this)));
	    actionBar.addTab(tab);
	    
	    // entrance/ exit
	    tab = actionBar.newTab().setText("Eingang").setTabListener(new TabListener(new EntranceHandler(mFloorPlan, this)));
	    actionBar.addTab(tab);
	    
	    // stairs/ elevator
	    tab = actionBar.newTab().setText("Treppe").setTabListener(new TabListener(new StairsHandler(mFloorPlan, this)));
	    actionBar.addTab(tab);
...
//		case R.id.action_automatic_mapping:
//			
//			AutoMapDialog autoMappingDialogFragment = new AutoMapDialog();
//			autoMappingDialogFragment.attachHandler(this);
//			
//			autoMappingDialogFragment.show(getSupportFragmentManager(), "Edit Room");
//			return true;
...
//	/*
//	 * called when opencvloader has finished
//	 */
